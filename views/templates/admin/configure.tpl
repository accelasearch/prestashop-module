...
<script>
    ...
    const _AST = {
        ...
        "Go to Accelasearch Dashboard" : "{l s='Go to Accelasearch Dashboard' mod='accelasearch'}",
        ...
        "An error occurred during sync your shops." : "{l s='An error occurred during sync your shops.' mod='accelasearch'}",
        ...
        "Need help? Read a module documentation" : "{l s='Need help? Read a module documentation' mod='accelasearch'}",
        ...
        "Exported products (based on your configuration)" : "{l s='Exported products (based on your configuration)' mod='accelasearch'}",
