        ...
        <div class="flex items-center w-full">
          ...
          <div class="as-hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4" id="as-menu-nav">
              <a href="javascript:void(0)" class="as-current-page no-underline bg-as-primary-700 text-white px-3 py-2 rounded-md text-sm font-medium" page="dashboard">Dashboard</a>
              <a href="javascript:void(0)" class="no-underline text-gray-100 hover:bg-as-primary-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium" page="product_sync">{l s='Product Synchronization' mod='accelasearch'}</a>
              <a href="javascript:void(0)" class="no-underline text-gray-100 hover:bg-as-primary-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium" page="advanced">{l s='Advanced' mod='accelasearch'}</a>
              <a href="javascript:void(0)" class="no-underline text-gray-100 hover:bg-as-primary-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium" page="support">{l s='Support' mod='accelasearch'}</a>
            </div>
          </div>
          <div class="ml-auto">
            <div class="relative inline-block text-left">
              ...
              <div class="as-dropdown origin-top-right absolute right-0 mt-2 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 divide-y divide-gray-100 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1" style="display:none">
                ...
                <div class="py-1" role="none">
                  <button id="disconnect_apikey" type="submit" class="text-red-600 block w-full text-left px-4 py-2 text-sm" role="menuitem" tabindex="-1">{l s='Disconnect Api Key' mod='accelasearch'}</button>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        <div class="mt-2 grid grid-cols-1 gap-5 lg:grid-cols-2">
          <div class="bg-white overflow-hidden shadow-md rounded-lg">
            <div class="p-5">
              <div class="flex items-center">
                ...
                <div class="ml-5 w-0 flex-1">
                  <dl>
                    <dt class="text-xl font-bold text-gray-700 truncate mb-2">{l s='Search Layer' mod='accelasearch'}</dt>
                    <dd>
            ...
            <div class="px-5 py-3">
              <div class="text-sm">
                <a href="https://console.accelasearch.io/setup" class="no-underline font-medium text-as-primary-400 hover:text-as-primary-700 flex items-center justify-end" target="_blank">
          ...
          <div class="bg-white overflow-hidden shadow-md rounded-lg">
            ...
            <div class="px-5 py-3">
              <div class="text-sm">
                <a href="javascript:void(0)" class="no-underline font-medium text-as-primary-400 hover:text-as-primary-700 flex items-center justify-end showCronModal">
        ...
        <div class="px-4 pb-6 sm:px-0">
                ...
                <div class="flex">
                  ...
                  <div class="ml-3 flex-1 md:flex md:justify-between">
                    ...
                    <p class="mt-3 text-sm md:mt-0 md:ml-6">
                      <a href="javascript:void(0)" class="whitespace-nowrap font-medium text-red-700 hover:text-red-600 showCronModal">{l s='How to setup' mod='accelasearch'} <span aria-hidden="true">&rarr;</span></a>
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div id="state-processing">
            <div class="flex items-center mb-8">
              <div>
                <div class="lds-ring branded"><div></div><div></div><div></div><div></div></div>
              </div>
              <div class="ml-4">
          ...
          <div class="p-6">
            <div class="text-center">
              ...
              <div id="with-issues" style="display:none">
                <svg xmlns="http://www.w3.org/2000/svg" class="mx-auto h-12 w-12 text-red-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                ...
                <p class="mt-1 text-sm text-gray-500">
                  {l s='There are some conflicts with your products data and AccelaSearch data'}.<br>
              ...
              <div class="mt-6">
                <button id="start_remote_checker" type="button" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-as-primary-400 hover:bg-as-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-as-primary-400">
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
    ...
    <div class="as-page as-hidden" page="advanced">
      ...
      <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
          ...
          <div class="bg-white overflow-hidden shadow-md rounded-lg">
            <div class="p-5">
              <div class="flex items-center">
                <div class="ml-5 w-0 flex-1">
                  <dl>
                    <dt class="text-xl font-bold text-gray-700 truncate mb-2">{l s='Users groups' mod='accelasearch'}</dt>
                    <dd>
                      ...
                      <div class="md:flex md:items-center md:justify-between">
                        ...
                        <div class="mt-4 flex md:mt-0 md:ml-4">
                          <button id="resync_users_groups" type="button" class="ml-3 inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-as-primary-400 hover:bg-as-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-as-primary-400">{l s='Re-sync all groups' mod='accelasearch'}</button>
                        </div>
                      </div>
                      {else}
                      <div class="md:flex md:items-center md:justify-between">
          ...
          <div class="bg-white overflow-hidden shadow-md rounded-lg">
            <div class="p-5">
              <div class="flex items-center">
                ...
                <div class="ml-5 w-0 flex-1">
                  <dl>
                    <dt class="text-xl font-bold text-gray-700 truncate mb-2">{l s='Resync all products' mod='accelasearch'}</dt>
                    <dd>
                      <div class="text-sm text-gray-500">
            ...
            <div class="px-5 py-3">
              <div class="text-sm text-right">
                <button type="button" class="inline-flex items-center px-2.5 py-1.5 border border-transparent text-xs font-medium rounded shadow-sm text-white bg-yellow-500 hover:bg-yellow-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-600 mr-2" id="resync_all_products">{l s='DELETE AND FULLSYNC CATALOG' mod='accelasearch'}</button>
              </div>
            </div>
          </div>
          <div class="bg-white overflow-hidden shadow-md rounded-lg">
        ...
        <div class="px-4 py-6 sm:px-0">
          {if $DEBUG_MODE}
          <div class="flex my-2">
            <button type="button" class="inline-flex items-center px-2.5 py-1.5 border border-transparent text-xs font-medium rounded shadow-sm text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 mr-2" id="shop_initializations">Shop initializations</button>
            <button type="button" class="inline-flex items-center px-2.5 py-1.5 border border-transparent text-xs font-medium rounded shadow-sm text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 mr-2" id="generate_products_query">Generate products query</button>
            <button type="button" class="inline-flex items-center px-2.5 py-1.5 border border-transparent text-xs font-medium rounded shadow-sm text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 mr-2" id="cleanup_products">Clean up products</button>
        ...
        <div>
          <div class="mt-1 flex rounded-md shadow-sm">
            <div class="relative flex items-stretch flex-grow focus-within:z-10">
              <input type="text" name="as_pid" id="as_pid" class="focus:ring-indigo-500 focus:border-indigo-500 block w-full rounded-none rounded-l-md pl-10 sm:text-sm border-gray-300" placeholder="Get AccelaSearch updated informations by PrestaShop product ID">
            </div>
            <button id="get_as_informations" type="button" class="-ml-px relative inline-flex items-center space-x-2 px-4 py-2 border border-gray-300 text-sm font-medium rounded-r-md text-gray-700 bg-gray-50 hover:bg-gray-100 focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500">
          ...
          <div class="p-3">
            <div class="flex flex-wrap">
              <div class="w-full sm:w-1/2 flex">
                ...
                <div>
                  <p class="">
                    <span class="text-xl font-extrabold text-gray-900 sm:text-2xl">{l s='What can you do with this module' mod='accelasearch'}</span>
                    <ul class="pl-4 pt-4">
